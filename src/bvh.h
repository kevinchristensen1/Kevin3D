...
class BVHAccel : public Aggregate {
 public:
  ...
  bool recursive_intersect(const Ray& r, BVHNode* node) const;
  /**
  ...
  bool recursive_intersect(const Ray& r, Intersection* i, BVHNode* node) const;
  /**
  ...
  //Added
  void buildRecursive(BVHNode* parent, BBox &broot, size_t max_leaf_size);
